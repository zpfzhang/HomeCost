...
namespace HomeCost.Models
{
    public class ADOHandle
    {
        ...
        public bool DataSetToExcel(DataSet dataSet, bool isShowExcle)
        {
            ...
            String fileName = mailAttachPath +"\\HomeCostList"+ DateTime.Now.ToString("yyyy-MM-dd-HH:mm:ss:ffff").Replace(':', '_') + ".xlsx";
            ...
            {
                AuthoriyService.LogInfo(exception.Message,"Excel Save");
            }
            finally
            {
            ...
            catch (Exception exception)
            {
                ...
                AuthoriyService.LogInfo(exception.Message, "Send Mail"); ;
            }
            return true;
        }
        ...
        public bool Sendmail(String strAttachfile)
        {
            ...
            mm.Subject = "Home Cost-"+DateTime.Now.ToString("yyyy-MM-dd");
